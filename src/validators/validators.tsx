...
const validators = {
    ...
    validateUsername: (value: string | undefined, fieldName: string): Validator => {
        ...
        let thisMessage : string | undefined = undefined;
      ...
      validatePasswordConfirm: (fieldName: string, value1: string | undefined,value2: string | undefined): Validator => {
        ...
        const maxLength : number = 40;
        const regex : RegExp = /^[\p{L}0-9\s\-]+$/;
        const formatDanychInfo : string = " Hasła muszą być takie same !";
        ...
        if(value1 !== undefined && value2 !== undefined){
            ...
            if(value1 == value2){
                thisMessage = "Hasła są identyczne"
                isStateValid = true;
            }
